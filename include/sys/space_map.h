...
typedef struct space_map_phys {
	...
	uint64_t	smp_alloc_class_id; /* optional segragated vdev class */
 ...
 */
typedef enum {
	SM_ALLOC_CLASS_DEFAULT =	0x0ULL,
	SM_ALLOC_CLASS_METADATA = 	0xa110cc1a55da7aULL,
	SM_ALLOC_CLASS_LOG =		0xa110cc1a551065ULL,
	SM_ALLOC_CLASS_SMALLBLKS =	0xa110cc1a55b10cULL
} map_alloc_class_t;
...
map_alloc_class_t space_map_get_alloc_class(space_map_t *sm);
void space_map_set_alloc_class(space_map_t *sm, map_alloc_class_t class);
